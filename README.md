...
С pinned checksum для archive:

```bash
curl -fsSL https://raw.githubusercontent.com/MALYSHVIP/cake-traffic-control/main/install.sh | sudo bash -s -- --sha256 <archive_sha256> --mode observer
```
